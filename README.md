...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/hapis21/AphroditeMusic)
...
npm i -g npm
git clone https://github.com/hapis21/AphroditeMusic # clone the repo.
cd VeezMusic
